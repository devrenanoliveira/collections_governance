...
- **assessorias**: Metas, comissão base, estrutura concorrencial (só contexto), portfolioVigente/portfolioExpectativa (share por assessoria vigente e expectativa não confirmada pro último tri/2026), perdeGanha (regra de redistribuição trimestral), premiacao (mensal/trimestral + bônus de prejuízo + forma de pagamento), governancaRepasse, rituais. A aba tem 4 toggles — Metas & Comissão / Share & Redistribuição / Premiação & Bônus / Rituais & Governança — todo renderizado nativamente (não há mais `regulamento.html`/iframe desde 22/09/2026: o conteúdo virou parte do `data.json`/`index.html` pra ganhar dark mode e fonte consistentes com o resto do dashboard)
